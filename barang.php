				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Rp.'.$row['harga_barang'].'<del class="product-old-price">Rp.2000000</del></h3>
							...
							<div class="add-to-cart">
								...
								<button class="add-to-cart-btn" pid="'.$row['id_barang'].'"  id="product" ><i class="fa fa-shopping-cart"></i> add to cart</button>
                                </div>
