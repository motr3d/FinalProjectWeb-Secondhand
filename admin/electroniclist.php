	...
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        $result=mysqli_query($con,"select id_barang,gambar_barang, nama_barang,harga_barang from barang  where  kategori_barang=1  Limit $page1,12")or die ("query 1 incorrect.....");

                        while(list($id_barang,$image,$nama_barang,$harga)=mysqli_fetch_array($result))
                        {
