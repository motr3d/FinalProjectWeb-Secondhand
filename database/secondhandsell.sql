...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Nov 2021 pada 04.55
...
INSERT INTO `categories` (`cat_id`, `cat_title`, `icons`) VALUES
(1, 'APA SAJA', NULL),
...
INSERT INTO `info_email` (`email_id`, `email`) VALUES
(3, 'admin@gmail.com'),
(6, 'aaaa@gmail.com');
...
INSERT INTO `order_produk` (`order_pro_id`, `order_id`, `product_id`, `qty`, `amt`) VALUES
(73, 1, 1, 1, 5000),
(74, 1, 4, 2, 64000),
(75, 1, 8, 1, 40000),
(91, 2, 1, 1, 5000),
...
INSERT INTO `produk` (`product_id`, `product_cat`, `product_brand`, `product_title`, `product_price`, `product_desc`, `product_image`, `product_keywords`) VALUES
...
INSERT INTO `info_user` (`user_id`, `first_name`, `last_name`, `email`, `password`, `mobile`, `address1`, `address2`) VALUES
(12, 'puneeth', 'Reddy', 'gatotsasangkataka@gmail.com', 'leonkers28', '9448121558', '123456789', 'sdcjns,djc'),
...
--
DELIMITER $$
CREATE TRIGGER `after_info_user_insert` AFTER INSERT ON `info_user` FOR EACH ROW BEGIN 
INSERT INTO info_user_backup VALUES(new.user_id,new.first_name,new.last_name,new.email,new.password,new.mobile,new.address1,new.address2);
END
$$
DELIMITER ;
...
INSERT INTO `info_user_backup` (`user_id`, `first_name`, `last_name`, `email`, `password`, `mobile`, `address1`, `address2`) VALUES
(26, 'gg', 'gg', 'gg@gmail.com', 'leonkers28', '1234567890', '2145 Hill Haven Drive', 'assd'),
(27, 'aaaa', 'aaaa', 'aaaa@gmail.com', 'leonkers28', '1234567890', '2145 Hill Haven Drive', 'aaaaaa');
...
--
ALTER TABLE `pesanan_produk`
  ADD CONSTRAINT `pesanan_produk` FOREIGN KEY (`order_id`) REFERENCES `orders_info` (`order_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `product_id` FOREIGN KEY (`product_id`) REFERENCES `produk` (`product_id`);
COMMIT;
